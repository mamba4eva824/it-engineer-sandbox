...
resource "aws_cloudwatch_metric_alarm" "lambda_errors" {
  ...
  alarm_description   = "Fires when the offboarding workflow Lambda records any error in a 5-minute window."
  ...
  dimensions = {
    FunctionName = aws_lambda_function.offboarding_workflow.function_name
  }

...
output "function_name" {
  ...
  value       = aws_lambda_function.offboarding_workflow.function_name
}

output "function_arn" {
  description = "Lambda function ARN."
  value       = aws_lambda_function.offboarding_workflow.arn
}
...
output "dynamodb_table_name" {
  ...
  value       = aws_dynamodb_table.offboarding_logs.name
}

#!/usr/bin/env bash
# Build the Lambda deployment zip for the ohmgym license reclaim broker.
#
# Output: lambdas/license_reclaim_broker/build/handler.zip
...
rm -rf "$BUILD"
mkdir -p "$BUILD/pkg/config/licenses"
